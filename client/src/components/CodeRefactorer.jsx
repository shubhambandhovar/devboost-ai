...
export default function CodeRefactorer() {
  ...
  const handleRefactor = async () => {
    ...
    try {
      const data = await callApi('/refactor-code', { code })
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="card">
        <h2 className="text-xl font-semibold mb-4 text-white">Code Refactorer & Optimizer</h2>
        <p className="text-gray-400 text-sm mb-4">Paste your messy or slow code below, and the AI will clean it up following best practices.</p>
        <textarea
          value={code}
          onChange={(e) => setCode(e.target.value)}
          placeholder="Paste your unoptimized code here..."
      ...
      {(result || loading) && (
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-white">Optimized Code</h2>
            {result && (
              <button 
                onClick={handleCopy}
