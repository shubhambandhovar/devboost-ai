        ...
        <div className="relative z-10 animate-slide-up-fade" style={{ animationDelay: '100ms' }}>
          ...
          <div className="mt-24 space-y-6 max-w-lg">
            ...
            <p className="text-lg text-gray-400 leading-relaxed animate-slide-up-fade" style={{ animationDelay: '400ms' }}>
              Create an account to save your generated code, schemas, and architecture plans. Your AI pair programmer awaits.
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          <div className="text-center animate-slide-up-fade" style={{ animationDelay: '100ms' }}>
            ...
            <p className="text-gray-400">Start boosting your productivity today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-2 animate-slide-up-fade" style={{ animationDelay: '700ms' }}>
              <button 
                type="submit" 
                disabled={loading} 
          ...
          <p className="text-center text-sm text-gray-400 animate-slide-up-fade" style={{ animationDelay: '800ms' }}>
            Already have an account? <Link to="/login" className="text-primary hover:text-primary/80 font-medium transition-colors duration-300 border-b border-transparent hover:border-primary">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
